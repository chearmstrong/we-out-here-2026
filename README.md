...
Browse the programme with search and day, venue, and category filters, then save events to **My plan**. On a phone, **Schedule** presents the selected day's programme as a chronological agenda; the visual time-and-venue timetable is available on larger screens. Each saved event can have one Event Note of up to 140 characters. Notes and selections stay on that browser and device; there is no cross-device sync.
